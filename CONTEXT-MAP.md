...
- **Personal Market Agent -> Research Fact Plane**: requests a versioned research purpose from Market and seals the returned Research Fact Bundle; the Agent cannot select providers, mappings, formulas, or quality.
