...
export const TASK_POLICIES: Record<string, Partial<AITaskPolicy>> = {
  ...
  "market-agent-close-review": { timeoutMs: 80_000, totalBudgetMs: 90_000, maxOutputTokens: 1_800, temperature: 0 },
  "market-agent-answer": { timeoutMs: 80_000, totalBudgetMs: 90_000, maxOutputTokens: 1_600, temperature: 0.2 },
  ...
  "yuzi-turn": { timeoutMs: 25_000, totalBudgetMs: 55_000, maxOutputTokens: 700, temperature: 0.72 },
};
