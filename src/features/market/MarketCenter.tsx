...
export default function MarketCenter() {
  ...
  const refresh = useCallback(async ({ slow = true }: { slow?: boolean } = {}) => {
    ...
    try {
      ...
      const [quotes, providers, sse, szse, news, announcements, bars] = await Promise.allSettled([
