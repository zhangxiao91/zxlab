...
export class ApiMarketDataProvider implements MarketDataProvider {
  ...
  constructor(private readonly baseUrl = (import.meta as ImportMeta & { env?: Record<string, string | undefined> }).env?.PUBLIC_RISK_MARKET_API_URL || "https://zxlab-risk-market.zhangxiao9118.workers.dev") {}
