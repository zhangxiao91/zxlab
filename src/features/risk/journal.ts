...
const emptyMarket = (): MarketDiagnostics => ({ provider: "尚未执行", lastSuccessAt: null, lastFailureAt: null, requestDurationMs: null, dataTimestamp: null, stale: true, snapshotStatus: "unavailable", exchangeStatus: [], realtimePolling: false, pollIntervalMs: 60_000, warnings: [], errors: [] });
