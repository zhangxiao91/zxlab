...
export type DigitalStarterStatus = "open" | "placeholder" | "building";
...
const DIGITAL_STARTER_UPDATED_AT = "2026-07-26";
...
export const digitalStarterRoutes = withUpdatedAt<DigitalStarterRoute>([
  {
    id: "computer",
    title: "电脑基础",
    subtitle: "从文件、软件、浏览器到同步和安全，把电脑用顺手。",
    description:
  ...
  },
  {
    ...
    links: [],
    assets: [],
    docs: ["ai-intro-doc", "ai-practical-doc"],
    resourceIds: ["ai-intro-doc", "ai-practical-doc"],
    detailHref: "/lab/digital-starter/ai",
    learningOutcome: "先理解 AI 的基本使用方式，再把它用于真实的学习和工作任务。",
    durationLabel: "2 个模块 · 约 40 分钟",
    actionLabel: "开始学习",
  },
  {
    id: "coding",
    ...
    links: [],
    assets: [],
    docs: ["hello-world-doc", "command-line-doc", "markdown-start-doc", "github-basics-doc", "ai-coding-doc"],
    resourceIds: ["hello-world-doc", "command-line-doc", "markdown-start-doc", "github-basics-doc", "ai-coding-doc"],
    detailHref: "/lab/digital-starter/coding",
    learningOutcome: "从 Hello World、命令行、Markdown 和 GitHub 开始，最后体验 AI Coding。",
    durationLabel: "4 个开放模块 + 1 个基础版模块",
    actionLabel: "开始学习",
  },
]);

export const digitalStarterRouteModules = withUpdatedAt<DigitalStarterRouteModule>([
  {
    id: "file-management",
    routeId: "computer",
    status: "open",
    ...
    task: "完成一次截图、规范命名、压缩和解压练习。",
    outcome: "学会创建、整理、查找、移动和备份文件。",
    coreDocumentId: "file-management-doc",
  ...
  },
  {
    ...
    status: "building",
    title: "硬件基础与电脑设置",
    description: "先分清关机、重启、睡眠和常见接口，再完成一轮新电脑基础设置检查。",
    capabilities: ["能正确选择关机、重启和睡眠", "能识别常见接口并安全连接外设", "能检查显示、电源、更新和存储设置"],
    task: "完成一次设备与 Windows 基础设置检查，不修改自己看不懂的高级选项。",
    outcome: "能安全处理日常开关机、外设连接和常用系统设置。",
  ...
  },
  {
    ...
    status: "building",
    title: "键盘与输入法",
    description: "掌握键盘认识、高频快捷键和输入法管理，让电脑用起来更顺手。",
    capabilities: [
      "复制、粘贴、剪切、撤销、保存",
      "全选、查找、重命名",
      "切换窗口和浏览器标签页",
    ...
    coreDocumentId: "keyboard-shortcuts-doc",
    practiceLabel: "只用快捷键完成一次保存与重命名",
    extensionDocumentId: "computer-help-prompt-doc",
    duration: "10 分钟",
  },
  {
    id: "software-safety",
    ...
    status: "open",
    title: "软件安装与安全",
    description: "建立安全下载、安装、卸载和防止养蛊的基础习惯。",
    capabilities: [
      "从官网或可信来源下载软件",
      "识别假下载按钮和捆绑安装",
      "能管理浏览器插件",
    ...
    task: "选择一个确实需要的小工具，完成找官网、下载安装包、安装和检查结果。",
    outcome: "能按真实需求选择软件，并从官方来源安全下载和安装。",
    coreDocumentId: "safe-download-guide",
    practiceTaskId: "software-shortlist",
    extensionDocumentId: "software-toolbox",
    duration: "20 分钟",
  },
  {
    id: "device-sync",
    ...
    coreDocumentId: "sync-plan-doc",
    practiceLabel: "写下自己的三层同步与备份方案",
    extensionDocumentId: "file-structure-doc",
    duration: "15 分钟",
  },
  {
    ...
    status: "open",
    title: "浏览器使用",
    description: "掌握标签页、收藏、下载记录和插件权限。",
    capabilities: ["会使用地址栏和标签页", "会查看下载记录", "知道插件来源和权限风险"],
    task: "用浏览器完成一次搜索、收藏和下载记录检查。",
    outcome: "把浏览器当作可靠的学习和资料入口。",
    coreDocumentId: "browser-basics-doc",
    extensionDocumentId: "software-toolbox",
    duration: "15 分钟",
  },
  {
    ...
    status: "open",
    title: "办公工具",
    description: "解决 PDF、Word、Excel、PowerPoint 和邮件中的高频问题。",
    capabilities: ["能正确导出和检查 PDF", "能处理 Word、Excel 和 PPT 的常见格式问题", "能写清楚主题、正文并检查邮件附件"],
    task: "完成一次办公文件提交前的 60 秒检查。",
    outcome: "能独立完成常见办公文件的编辑、导出、检查和邮件发送。",
    coreDocumentId: "office-tools-doc",
    duration: "25 分钟",
  },
  {
    id: "troubleshooting",
    ...
    status: "open",
    title: "故障排查",
    description: "先做任务管理器、磁盘和网络的基础判断，再清楚地求助。",
    capabilities: ["会打开任务管理器", "能初步判断磁盘和网络问题", "能提供清楚的报错信息"],
    task: "用求助模板描述一次真实或模拟的电脑问题。",
    outcome: "遇到问题时知道先看哪里、怎么说清楚。",
    coreDocumentId: "troubleshooting-doc",
    extensionDocumentId: "computer-help-prompt-doc",
    duration: "15 分钟",
  },
  {
    ...
    status: "open",
    title: "反诈与账号安全",
    description: "把验证码、远程控制、假下载和账号保护的提醒集中起来。",
    capabilities: ["识别常见催促和授权话术", "知道遇到可疑情况先停下", "能通过官方渠道核验"],
    task: "完成一次可疑链接和软件来源的核验练习。",
    outcome: "给自己留出核验时间，不被催促着做高风险操作。",
    coreDocumentId: "anti-fraud-doc",
    extensionDocumentId: "safe-download-guide",
    duration: "10 分钟",
  },
  {
    id: "not-easy-to-say",
    ...
    status: "building",
    title: "那些不方便直接讲的",
    description: "面对破解软件、账号借用、代做和隐私灰区时，先判断风险和边界。",
    capabilities: ["识别破解软件和陌生脚本的风险", "知道账号、作业和个人资料不能随意转交", "遇到灰区时能暂停并寻找正式渠道"],
    task: "用风险清单判断一个自己拿不准的数字场景。",
    outcome: "不靠冒险试错解决问题，知道什么时候应该停下来求助。",
    coreDocumentId: "digital-boundaries-doc",
    duration: "10 分钟",
  },
  {
    id: "ai-intro",
    ...
    status: "open",
    title: "AI 基础",
    description: "从任务描述、上下文、结果核验和隐私边界开始。",
    capabilities: ["能写清任务、上下文和验收标准", "能核验关键事实和来源", "知道哪些敏感信息不能上传"],
    task: "用四部分结构重写一个真实但不敏感的问题。",
    outcome: "把 AI 输出当作可核验的草稿，而不是自动正确的答案。",
    coreDocumentId: "ai-intro-doc",
    duration: "20 分钟",
  },
  {
    id: "ai-ppt",
    ...
    status: "open",
    title: "实战 AI 使用",
    description: "把一份真实材料整理成可核验的大纲或 PPT 页面结构。",
    capabilities: ["区分原文事实和 AI 推断", "按读者、用途和时长生成大纲", "核验日期、数字、名称和引用"],
    task: "从一份不敏感材料生成并人工修订一份大纲。",
    outcome: "完成一份有来源、有结构、经过人工核验的内容大纲。",
    coreDocumentId: "ai-practical-doc",
    duration: "20 分钟",
  },
  {
    id: "hello-world",
    ...
    capabilities: ["能运行一行 JavaScript", "能修改变量并观察输出", "能阅读并修正一个简单报错"],
    task: "运行控制台代码，并保存一个可以在浏览器打开的 hello.html。",
    outcome: "走通代码、运行环境和输出结果的最小链路。",
    coreDocumentId: "hello-world-doc",
    duration: "15 分钟",
  },
  {
    id: "command-line",
    ...
    status: "open",
    title: "命令行",
    description: "认识文件路径、命令和程序运行环境。",
    capabilities: ["能查看当前目录", "能列出文件并切换目录", "知道陌生命令不能直接复制运行"],
    task: "从终端找到 hello.html，并在上一级和练习目录之间切换。",
    outcome: "能在图形界面和命令行中找到同一个文件。",
    coreDocumentId: "command-line-doc",
    duration: "15 分钟",
  },
  {
    id: "markdown",
    ...
    status: "open",
    title: "Markdown",
    description: "从清晰的文本结构开始体验技术文档和版本管理。",
    capabilities: ["能使用标题、列表、链接和代码块", "能预览 Markdown", "能写一份最小 README"],
    task: "为 Hello World 练习创建 README.md。",
    outcome: "写出一份结构清楚、可预览和可维护的项目说明。",
    coreDocumentId: "markdown-start-doc",
    duration: "15 分钟",
  },
  {
    id: "github",
    ...
    status: "open",
    title: "GitHub",
    description: "认识代码仓库、提交和协作。",
    capabilities: ["理解仓库、提交、分支和远程副本", "能创建仓库并提交文件", "能在提交前检查隐私和凭证"],
    task: "把 README.md 和 hello.html 提交到第一个 GitHub 仓库。",
    outcome: "完成从本地文件到 GitHub 提交历史的最小闭环。",
    coreDocumentId: "github-basics-doc",
    duration: "20 分钟",
  },
  {
    id: "vibe-coding",
    ...
    capabilities: ["能把一个小改动拆成清楚的要求", "能先查看 diff 再接受 AI 修改", "知道密钥、隐私文件和危险命令不能随意交给 AI"],
    task: "让 AI 为 hello.html 增加一个小功能，逐行检查改动后再运行。",
    outcome: "完成一次有需求、有检查、有验证的 AI 辅助改动。",
    coreDocumentId: "ai-coding-doc",
    duration: "20 分钟",
  },
]);
...
export const digitalStarterDocs: DigitalStarterDoc[] = [
  {
    ...
    title: "电脑基础速查表",
    routeId: "computer",
    description: "电脑基础路线导航，按问题找到文件、软件、浏览器、同步和安全文档。",
    path: "/lab/digital-starter/docs/computer-basics",
    status: "building",
    updatedAt: "2026-07-25",
  },
  {
    id: "file-management-doc",
    title: "文件管理基础",
    routeId: "computer",
    description: "认识常用位置、下载目录、文件扩展名、压缩包和 Windows 文件名。",
    path: "/lab/digital-starter/docs/file-management",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
  ...
  {
    id: "browser-basics-doc",
    title: "浏览器使用基础",
    routeId: "computer",
    description: "从地址栏、标签页、收藏和下载记录开始，理解浏览器插件的来源和权限。",
    path: "/lab/digital-starter/docs/browser-basics",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
  ...
  },
  {
    ...
    title: "办公工具速讲",
    routeId: "computer",
    description: "解决 PDF、Excel、PowerPoint、Word 和邮件中的高频操作与提交问题。",
    path: "/lab/digital-starter/docs/office-tools",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
  ...
  },
  {
    ...
    title: "电脑故障排查",
    routeId: "computer",
    description: "从任务管理器、磁盘空间和网络连接开始做安全的基础排查。",
    path: "/lab/digital-starter/docs/troubleshooting",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
    ...
    title: "反诈与账号安全基础",
    routeId: "computer",
    description: "集中整理验证码、远程控制、假下载和账号保护的提醒。",
    path: "/lab/digital-starter/docs/anti-fraud",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
    id: "digital-boundaries-doc",
    title: "数字使用中的边界与灰区",
    routeId: "computer",
    description: "面对破解软件、账号借用、代做、隐私资料和陌生脚本时，先判断风险再行动。",
    path: "/lab/digital-starter/docs/digital-boundaries",
    status: "building",
    updatedAt: "2026-07-26",
  },
  {
    ...
    title: "下载中心",
    routeId: "computer",
    description: "按真实使用场景选择软件、浏览器插件和网站，并从官方入口获取。",
  ...
  },
  {
    ...
    title: "AI 基础",
    routeId: "ai",
    description: "从任务描述、上下文、结果核验和隐私边界开始使用 AI。",
  ...
  },
  {
    ...
    path: "/lab/digital-starter/docs/ai-practical",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
    ...
    title: "Hello World",
    routeId: "coding",
    description: "运行第一个最小程序，认识代码、输出、报错和重新运行。",
    path: "/lab/digital-starter/docs/hello-world",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
    ...
    title: "命令行基础",
    routeId: "coding",
    description: "认识终端、当前目录和文件路径，用安全的命令找到文件。",
    path: "/lab/digital-starter/docs/command-line",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
  ...
  {
    id: "github-basics-doc",
    title: "GitHub 基础",
    routeId: "coding",
    description: "认识仓库、提交和远程副本，把 README 放进第一个 GitHub 仓库。",
    path: "/lab/digital-starter/docs/github-basics",
    status: "open",
    updatedAt: "2026-07-25",
  },
  {
    ...
    path: "/lab/digital-starter/docs/ai-coding",
    status: "building",
    updatedAt: "2026-07-26",
  },
];

export const digitalStarterAssets = withUpdatedAt<DigitalStarterAsset>([
  {
    id: "college-folder-template",
    title: "大学资料文件夹模板",
    routeId: "computer",
    fileType: "ZIP",
    description: "目录结构和手动创建步骤已经开放，可下载 ZIP 仍在制作中。",
    url: "/lab/digital-starter/docs/file-structure",
    status: "building",
  },
]);

export const digitalStarterResources = withUpdatedAt<DigitalStarterResource>([
  {
    id: "computer-basics",
    title: "电脑基础速查表",
    type: "document",
  ...
  },
  {
    ...
    type: "task",
    routeId: "computer",
    description: "走完确认需求、核对官网、检查安装包、安装和验收的完整流程。",
    url: "/lab/digital-starter/docs/safe-install-task",
    status: "open",
    tags: ["任务", "软件下载", "安装安全"],
    actionLabel: "开始任务",
  },
  ...
  },
  {
    ...
    type: "document",
    routeId: "ai",
    description: "用一份真实材料生成并核验大纲或 PPT 页面结构。",
    url: "/lab/digital-starter/docs/ai-practical",
    status: "open",
    tags: ["文档", "AI", "实战"],
    actionLabel: "开始练习",
  },
  {
    ...
    type: "document",
    routeId: "coding",
    description: "运行第一行代码，观察输出、报错和修改结果。",
    url: "/lab/digital-starter/docs/hello-world",
    status: "open",
    tags: ["文档", "编程入门"],
    actionLabel: "开始运行",
  },
  {
    ...
    type: "document",
    routeId: "coding",
    description: "认识当前目录、文件路径和安全的基础命令。",
    url: "/lab/digital-starter/docs/command-line",
    status: "open",
    tags: ["文档", "命令行"],
    actionLabel: "开始练习",
  },
  ...
  },
  {
    ...
    type: "document",
    routeId: "coding",
    description: "创建仓库、提交 README，并检查隐私和凭证。",
    url: "/lab/digital-starter/docs/github-basics",
    status: "open",
    tags: ["文档", "GitHub"],
    actionLabel: "开始阅读",
  },
  {
    ...
    type: "document",
    routeId: "coding",
    description: "从一个小网页改动开始，练习描述需求、检查差异和验证结果。",
    url: "/lab/digital-starter/docs/ai-coding",
    status: "building",
    tags: ["文档", "AI Coding", "代码检查"],
    actionLabel: "开始体验",
  },
]);

export const digitalStarterFeaturedResources = withUpdatedAt<DigitalStarterFeaturedResource>([
  {
    id: "computer-basics",
    typeLabel: "文档",
    title: "电脑基础速查",
  ...
  },
  {
    ...
    duration: "完成约 20 分钟",
    status: "open",
    href: "/lab/digital-starter/docs/ai-practical",
    actionLabel: "开始练习",
  },
  {
...
export const digitalStarterTasks = withUpdatedAt<DigitalStarterTask>([
  ...
  },
  {
    ...
    title: "找官网、下载与安装",
    description:
      "选择一个确实需要的小工具，核对官网和安装包，完成安装并检查是否出现捆绑内容。",
    steps: ["确认真实需求", "核对官网域名", "检查安装包和发布者", "完成安装后检查"],
    status: "open",
  },
]);
...
export const digitalStarterSoftwareTools = withUpdatedAt<DigitalStarterSoftwareTool>([
  {
    id: "browser-basics",
...
export const digitalStarterWebsiteRecommendations = withUpdatedAt<DigitalStarterWebsiteRecommendation>([
  {
    id: "monkeytype",
    name: "Monkeytype",
...
export const digitalStarterUpdates: DigitalStarterUpdate[] = [
  {
    date: "2026-07-26",
    title: "清理完全占位内容",
    description: "为硬件基础、数字边界与 AI Coding 提供可直接使用的基础版正文，移除失效资源入口，并统一增加持续补充标识。",
  },
  {
    date: "2026-07-25",
    title: "开放首批完整学习闭环",
...
export const digitalStarterConnectionNotes = [
  ...
  String(digitalStarterAssets.length) + " 类配套资产正在制作",
