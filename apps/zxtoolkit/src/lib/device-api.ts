import type { Device, DeviceCredential, DevicePlatform, DropItem, DropPayload, PairingSessionResponse, PairingStatusResponse, PublicPulseSnapshot, PublicStatusResponse } from "../../shared/types";
