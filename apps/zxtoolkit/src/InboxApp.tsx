...
export default function InboxApp() {
  ...
  return <main className="utility-page inbox-page">
    <header className="utility-nav"><a href="/"><ArrowLeft size={16} /> zxtoolkit</a><span className="inbox-device"><a href="/pulse">Pulse</a><Smartphone size={15} /> {credential?.device.name ?? "未配对设备"}</span></header>
