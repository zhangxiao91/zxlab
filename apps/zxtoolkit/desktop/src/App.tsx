...
function batteryText(percent: number | undefined, legacy: "high" | "medium" | "low" | undefined): string { return percent != null ? `${percent}%` : legacy === "high" ? "高" : legacy === "medium" ? "中" : legacy === "low" ? "低" : "未知"; }
