...
import { createPairingSession, getDevices, getPairingStatus, getPublicStatus, getRecentDrops, removeDevice, sendDrop } from "../../src/lib/device-api";
...
export default function DesktopApp() {
  ...
  return <main className="desktop-shell">
    <header className="desktop-header"><div className="desktop-brand"><span>z</span><strong>zxtoolkit</strong></div><i className="online-dot" /></header>
